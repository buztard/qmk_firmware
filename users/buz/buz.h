...
#define _________________ADJUST_R2_________________        _______, _______, _______, _______, KC_SINS
...
#define __________________VIM_R2___________________        KC_LEFT, KC_UP,   KC_DOWN, KC_RGHT, _______
