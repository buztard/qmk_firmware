...
#if defined(KEYBOARD_crkbd_rev1_kb2040)
#    define MASTER_LEFT
#else
#    define EE_HANDS
#endif
...
#if defined(FLAVOR_ACAB) || defined(FLAVOR_PICO)
#    define RGB_MATRIX_KEYPRESSES
#    define RGB_MATRIX_FRAMEBUFFER_EFFECTS
...
// Enable the Pimoroni trackball for this device
#if defined(FLAVOR_PICO)
